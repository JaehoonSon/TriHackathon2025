...
def send_prompt():
    ...
    if not file_ids or not prompt or not isinstance(file_ids, list):
        ...
        response = chat_session.send_message("""
            ...
            Prompt: Show me strikouts
            Answer: {"message": "Would love to show you, but please upload the videos"}
            Prompt: Show me blue jays.
            Answer: {"message": "That sounds exciting, but upload the videos for me to analyze"}
            Prompt: Greetings.
            Answer: {"message": "Hey there! Would love to show you great clips. Feel free to upload the videos"}
        """)
