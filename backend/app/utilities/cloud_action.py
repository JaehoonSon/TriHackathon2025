...
credentials = service_account.Credentials.from_service_account_file("/app/utilities/theblucks-mail-ab00183adf13.json")
...
def upload_to_gemini(file_data, mime_type=None, file_name=None, display_name=None):
    ...
    # If file_data is already a BytesIO instance, use it directly; otherwise, wrap it.
